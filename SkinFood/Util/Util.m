...
{
//    [[UINavigationBar appearance] setBackgroundImage:BundleImage(@"main_top_logo.png") forBarMetrics:UIBarMetricsDefault];
    
    [[UINavigationBar appearance] setBackgroundColor:kMainColor];
...
+ (NSString *)getDeviceName
{
    ...
    else if( [str_Model isEqualToString:@"iPhone9,1"] || [str_Model isEqualToString:@"iPhone9,3"] )
    {
        str_Model = @"iPhone7";
    }
    else if( [str_Model isEqualToString:@"iPhone9,2"] || [str_Model isEqualToString:@"iPhone9,4"] )
    {
        str_Model = @"iPhone7Plus";
    }
...
+ (NSDateComponents *)getComponent:(NSCalendar *)calendar withData:(NSDate *)date
{
    ...
    else
    {
        ...
        components = [calendar components:calendarUnits fromDate:date];
...
+ (void)makeShadow:(UIView *)view
{
    ...
    [view.layer setShadowColor:[UIColor colorWithRed:200.f/255.f green:200.f/255.f blue:200.f/255.f alpha:1].CGColor];
...
+ (void)showOneAlert:(UIViewController *)vc withMsg:(NSString *)aMsg
{
