...
{
    UIButton *btn_BarItem = [UIButton buttonWithType:UIButtonTypeCustom];
    btn_BarItem.frame = CGRectMake(0, 0, 28, 28);
    [btn_BarItem setImage:BundleImage(@"btn_login_back.png") forState:UIControlStateNormal];
...
- (UIBarButtonItem *)leftSideMenu
{
    UIButton *btn_BarItem = [UIButton buttonWithType:UIButtonTypeCustom];
    btn_BarItem.frame = CGRectMake(0, 0, 44, 44);
    btn_BarItem.imageEdgeInsets = UIEdgeInsetsMake(0, -40, 0, 0);
    [btn_BarItem setImage:BundleImage(@"global_menu.png") forState:UIControlStateNormal];
    //    [btn_BarItem setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [btn_BarItem addTarget:self action:@selector(leftSideMenuPress:) forControlEvents:UIControlEventTouchUpInside];
    
    return [[UIBarButtonItem alloc] initWithCustomView:btn_BarItem];
}
//btn_login_back
- (void)leftSideMenuPress:(UIButton *)btn
{
...
- (UIBarButtonItem *)rightQnaRoomInfoAndIcon:(UIImage *)image
{
...
{
    UIButton *btn_BarItem = [UIButton buttonWithType:UIButtonTypeCustom];
    btn_BarItem.frame = CGRectMake(0, 0, 85, 48);
    [btn_BarItem addTarget:self action:@selector(settingButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
...
- (NSUInteger)supportedInterfaceOrientations
{
    if( [self isKindOfClass:[UINavigationController class]] )
    {
        ...
        if( [firtVc isKindOfClass:[MWPhotoBrowser class]] )
        {
...
- (IBAction)goHome:(id)sender
{
    ...
    [navi.view addSubview:v_StatusBg];
...
//    [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleDefault];
    ...
    lb_Title.tag = kNaviTitleTag;
//    lb_Title.font = [UIFont fontWithName:@"Helvetica-Bold" size:18];
    lb_Title.font = [UIFont fontWithName:@"Helvetica-SemiBold" size:17];
    ...
    UIView *v_StatusBg = [[UIView alloc] initWithFrame:CGRectMake(0, -20,[UIScreen mainScreen].bounds.size.width, 20)];
    v_StatusBg.backgroundColor = [UIColor blackColor];
    [self.navigationController.navigationBar addSubview:v_StatusBg];
}
